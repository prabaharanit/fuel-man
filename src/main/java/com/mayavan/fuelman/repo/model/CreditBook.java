...
public class CreditBook {
	...
	public CreditBook(int vh_id, int fuel_type_id, double litre_sale_volumne, double amount_of_sale, int is_deleted, int is_paid, Timestamp dttm_of_sale, Timestamp created_dttm, Timestamp modified_dttm) {
		this.vh_id = vh_id;
